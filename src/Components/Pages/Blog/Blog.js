    ...
    return (
        <div className='home py-3'>
            ...
            <Container>
                <Card className='mb-3'>
                    <Card.Body>
                        <Card.Title className='blog-card-title bg-primary p-2 text-light rounded-top'><FaHandPointRight /> What is CORS ?</Card.Title>
                        <hr />
                ...
                <Card className='mb-3'>
                    <Card.Body>
                        <Card.Title className='blog-card-title bg-primary p-2 text-light rounded-top'><FaHandPointRight /> Why am I using Firebase? What other options I could use to implement Authentication ?</Card.Title>
                        <hr />
                        <Card.Text className='text-start'>
                ...
                <Card className='mb-3'>
                    <Card.Body>
                        <Card.Title className='blog-card-title bg-primary p-2 text-light rounded-top'><FaHandPointRight /> How does Private Route works ?</Card.Title>
                        <hr />
                        <Card.Text className='text-start'>
                ...
                <Card className='mb-3'>
                    <Card.Body>
                        <Card.Title className='blog-card-title bg-primary p-2 text-light rounded-top'><FaHandPointRight /> What is Node ? How does Node work ?</Card.Title>
                        <hr />
                        <Card.Text className='text-start'>
